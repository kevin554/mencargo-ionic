...
/**
 * Generated class for the EditarFamiliarPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-editar-familiar',
  templateUrl: 'editar-familiar.html',
})
export class EditarFamiliarPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad EditarFamiliarPage');
  }
  ...
  public irARegistroUsuarioPassword(){
    this.navCtrl.setRoot("RegistrarUsuarioPasswordPage");
  }
}
